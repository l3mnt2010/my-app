...
const Blogs = () => {
  ...
  return (
    <div className="w-full text-left">
      <div className="w-5/6 mx-auto flex gap-5 ">
        ...
        <div className="w-1/3 my-10">
          <input
            ...
            className="hidden sm:block w-full h-10 border-2 border-orange-400 rounded-lg"
          />
          <img src={line} className="w-2/3 mx-auto my-10" />
      ...
      <p className="w-full text-center">Trang</p>
      <div className="w-5/6 mx-auto flex justify-around my-5">
        {page.map((itm) => (
          <div className="shadow-2xl text-black px-2 font-bold">{itm}</div>
        ))}
      </div>
      <Footer />
    </div>
